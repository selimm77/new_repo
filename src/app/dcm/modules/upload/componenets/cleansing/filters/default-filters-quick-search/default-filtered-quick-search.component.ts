...
@Component({
    templateUrl: 'default-filtered-quick-search.component.html',
    styleUrls: ['default-filtered-quick-search.component.scss'],
    selector: 'filter-cell'
})
export class DefaultFilteredQuickSearchComponent implements IFilterAngularComp {
    ...
    constructor(private cdrf: ChangeDetectorRef,
        ...
        private store$: Store<AppState>, private fileImportService: FileImportService, fb: FormBuilder) {
        ...
        combineLatest(
            ...
            this.importData$.subscribe((importData) => {
                ...
                if (this.columnCode !== undefined && this.txt !== '') {
